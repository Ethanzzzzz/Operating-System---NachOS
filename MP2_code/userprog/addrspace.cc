...
bool AddrSpace::Load(char *fileName) {
    ...
    if (noffH.code.size > 0) {
        ...
        executable->ReadAt(
            &(kernel->machine->mainMemory[pageTable[noffH.code.virtualAddr >> 7].physicalPage * 128]),
    ...
    if (noffH.initData.size > 0) {
        ...
        executable->ReadAt(
            &(kernel->machine->mainMemory[pageTable[noffH.initData.virtualAddr >> 7].physicalPage * 128]),
    ...
    if (noffH.readonlyData.size > 0) {
        ...
        executable->ReadAt(
            &(kernel->machine->mainMemory[pageTable[noffH.readonlyData.virtualAddr >> 7].physicalPage * 128]),
